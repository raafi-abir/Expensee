...
val LightAppColors = AppColors(
    ...
    incomeBlueBg = Color(0xFFEAF5EC),
    expenseRedBg = Color(0xFFFDEEE9),
    goalOrangeBg = Color(0xFFFFEDD5),
    activeNavTint = Color(0xFF2E7D32),
    inactiveNavTint = Color(0xFF6B7280)
)

val DarkAppColors = AppColors(
    isDark = true,
    pageBg = Color(0xFF121315),
    cardBg = Color(0xFF1A1D21),
    cardBorder = Color(0xFF282B30),
    textDark = Color(0xFFF3F4F6),
    textSubtle = Color(0xFF9CA3AF),
    textLight = Color(0xFF71717A),
    segmentTrack = Color(0xFF262626),
    surfaceElevated = Color(0xFF222428),
    chipBg = Color(0xFF222428),
    inputBg = Color(0xFF1A1D21),
    incomeBlueBg = Color(0xFF172920),
    expenseRedBg = Color(0xFF2B191D),
    goalOrangeBg = Color(0xFF381D0E),
    activeNavTint = Color(0xFF4CAF50),
    inactiveNavTint = Color(0xFF8C929B)
)
